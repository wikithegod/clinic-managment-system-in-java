...
public class Doctors extends javax.swing.JFrame {
    ...
    try {
        ...
        DoctorList.setModel(DbUtils.resultSetToTableModel(rs));
    } catch (SQLException e) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Laborotary Managment System d");
        ...
        jLabel13.setText("Doctor Number");
        ...
        jLabel15.setText("Doctor PNumber");
        ...
        jLabel16.setText("Doctor Address");

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Doctor Birthday");
        ...
        DoctorList.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        DoctorList.setRowMargin(1);
        DoctorList.setSelectionBackground(new java.awt.Color(0, 102, 255));
        ...
        DocSp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DocSpActionPerformed(evt);
            }
        });

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel18.setText("Doc Sp");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(DocSp, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(DocSp, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(AddBtn)
                        .addGap(18, 18, 18)
    ...
    private void AddBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddBtnMouseClicked
       /*      if (PNumTb.getText().isEmpty() || PNameTb.getText().isEmpty() || PPhoneTb.getText().isEmpty() || AddressTb.getText().isEmpty() || GenCb.getSelectedIndex() == -1) {
        ...
        if (PNumTb.getText().isEmpty() || PNameTb.getText().isEmpty() || PPhoneTb.getText().isEmpty() || AddressTb.getText().isEmpty() || GenCb.getSelectedIndex() == -1 || DocSp.getText().isEmpty()) {
        JOptionPane.showMessageDialog(this, "Missing Data");
    } else {
        try {
            con = (Connection) DriverManager.getConnection("jdbc:mariadb://localhost:3306/MedicalLabdb", "root", "1234");
            ...
            java.util.Date utilDob = DOBTb.getDate();
            java.sql.Date sqlDob = new java.sql.Date(utilDob.getTime());
            java.time.LocalDate dob = sqlDob.toLocalDate();
            java.time.LocalDate currentDate = java.time.LocalDate.now();
            long age = java.time.temporal.ChronoUnit.YEARS.between(dob, currentDate);

            if (age < 18) {
                JOptionPane.showMessageDialog(this, "Doctor must be at least 18 years old.");
                return;
            }
            ...
            Add.setDate(6, sqlDob); // Set the date of birth
            Add.setString(7, DocSp.getText());
            ...
            if (row > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Failed to add new Doctor");
            }
    ...
    int selectedRowIndex = DoctorList.getSelectedRow();
    ...
    if (selectedRowIndex >= 0) {
        ...
        GenCb.setSelectedItem(model.getValueAt(selectedRowIndex, 2).toString());
         DocSp.setText(model.getValueAt(selectedRowIndex, 6).toString());
  ...
  if (PNumTb.getText().isEmpty() || PNameTb.getText().isEmpty() || PPhoneTb.getText().isEmpty() || AddressTb.getText().isEmpty() || GenCb.getSelectedIndex() == -1 || DocSp.getText().isEmpty()) {
        ...
        try {
            ...
            PreparedStatement Update = con.prepareStatement("UPDATE  doctortbl SET DocName=?, DocGen=?, DocAdd=?, DocPhone=?, DocDob=?, DocSp=? WHERE DocNum=?");

            // Set the values for the parameters
            Update.setString(1, PNameTb.getText()); // DocName
            Update.setString(2, GenCb.getSelectedItem().toString()); // DocGen
            Update.setString(3, AddressTb.getText()); // DocAdd
            Update.setString(4, PPhoneTb.getText()); // DocPhone
            Update.setDate(5, sqlDob); // DocDob
            Update.setString(6, DocSp.getText()); // DocSp
            Update.setInt(7, Integer.parseInt(PNumTb.getText())); // DocNum
    ...
    int dialogResult = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete this Doctor?", "Confirm Delete", JOptionPane.YES_NO_OPTION);
    
    if (dialogResult == JOptionPane.YES_OPTION) {
        try {
            con = (Connection) DriverManager.getConnection("jdbc:mariadb://localhost:3306/MedicalLabdb", "root", "1234");
            PreparedStatement Delete = con.prepareStatement("DELETE FROM doctortbl WHERE DocNum=?");
    ...
    private void DocSpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DocSpActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DocSpActionPerformed
